 ...
 */
export type TagFormat = "label2x1" | "label225x15" | "label15x225" | "label50x50" | "label" | "label3x2" | "hang";
export const TAG_FORMATS: { code: TagFormat; label: string; size: string; w: number; h: number }[] = [
  ...
  { code: "label225x15", label: "2.25 × 1.5 in label", size: "57.15 × 38.1 mm", w: 57.15, h: 38.1 },
  { code: "label15x225", label: "1.5 × 2.25 in label (portrait)", size: "38.1 × 57.15 mm", w: 38.1, h: 57.15 },
  { code: "label50x50", label: "5 × 5 cm label", size: "50 × 50 mm", w: 50, h: 50 },
