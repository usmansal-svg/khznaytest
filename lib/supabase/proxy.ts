...
import { homeFor, permissionForPath, permissionsFor } from "@/lib/auth/permissions";
...
export async function updateSession(request: NextRequest) {
  ...
  // Their own list (set on the Staff screen) beats the role's default.
  if (staff) {
    const perms = permissionsFor(staff.role, staff.perms ?? null);
