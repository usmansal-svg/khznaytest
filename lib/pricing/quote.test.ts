...
const ctx: PricingContext = {
  ...
  subCategories: SUB_CATEGORIES.map((s) => ({ ...s, gender: /women/.test(s.categorySlug) ? "women" : /children/.test(s.categorySlug) ? "kid" : "men", standardCost: null, marketPrice: null, season: "all" as const })),
  source: "database",
};
