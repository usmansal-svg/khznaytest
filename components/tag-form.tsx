...
export function TagForm() {
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">Brand &amp; size</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-3"><CardTitle className="flex items-center gap-2 text-base">Condition &amp; price</CardTitle></CardHeader>
          <CardContent className="space-y-5">
            <ButtonGroup
              label="Condition"
      ...
      {/* --------------------------------------------------------- price */}
      <div className="lg:sticky lg:top-6 lg:self-start lg:space-y-4 max-lg:grid max-lg:grid-cols-2 max-lg:gap-3">
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            {price && !price.restricted && price.markdowns?.length ? (
              <dl className="space-y-0.5 border-t pt-2 text-xs max-lg:hidden">
